-- Upsert de formulários USCIS principais com schemas e regras de validação/mapeamento
-- I-130, I-485, I-765, I-864, N-400 (versão 1)

-- Helper: evita repetição em múltiplos INSERTs
WITH upserts AS (

-- Corrigir migração removendo campo sort_order que não foi criado
...
-- Inserir módulos básicos do sistema (sem sort_order)
INSERT INTO public.system_modules (name, display_name, description, icon) VALUES
('cases', 'Gestão de Casos', 'Visualizar, criar e gerenciar casos jurídicos', 'briefcase'),
('clients', 'Gestão de Clientes', 'Visualizar, criar e gerenciar clientes', 'users'),
('documents', 'Gestão de Documentos', 'Visualizar, fazer upload e gerenciar documentos', 'file-text'),
('templates', 'Templates', 'Gerenciar templates de documentos e checklists', 'layout-template'),
('billing', 'Faturamento', 'Visualizar e gerenciar faturas e pagamentos', 'credit-card'),
('analytics', 'Relatórios e Analytics', 'Visualizar relatórios e métricas', 'bar-chart'),
('user_management', 'Gestão de Usuários', 'Gerenciar usuários, funções e permissões', 'user-cog'),
('settings', 'Configurações', 'Configurações gerais do sistema', 'settings')
